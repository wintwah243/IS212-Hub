...
- **Core Mechanisms for Prediction:** 
    ...
    **Classification:** This is like sorting items into labeled "buckets" or classes.
    ...
    Classificationက အချက်အလက်တွေကို နာမည်တပ်ထားတဲ့ "အုပ်စု (Labeled buckets or classes)" တွေထဲကို စနစ်တကျ ရွေးထုတ် ထည့်သွင်းတာနဲ့ တူတယ်။ (ဥပမာ: Credit Card လျှောက်ထားသူအသစ်တစ်ယောက်ရဲ့ အဝင်လစာ (Income) နဲ့ အသက် (Age) ကို ကြည့်ပြီး သူက ဘဏ်အတွက် "အန္တရာယ်ကင်းတဲ့သူ (Good risk)" လား၊ ဒါမှမဟုတ် "အန္တရာယ်ရှိတဲ့သူ (Bad risk)" လားဆိုပြီး အုပ်စုနှစ်ခုထဲက တစ်ခုခုထဲ ရောက်အောင် ကြိုတင်ခန့်မှန်းပေးတာမျိုး)
